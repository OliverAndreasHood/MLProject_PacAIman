...
class Enemy:
    ...
    def move(self):
        ...
        if self.personality in ["scared","slow","speedy"]:
    ...
    def get_pix_pos(self):
        return vec((self.grid_pos.x*self.app.cell_width)+T_B_BUFFER//2+self.app.cell_width//2,
                   (self.grid_pos.y*self.app.cell_height)+T_B_BUFFER//2 +
